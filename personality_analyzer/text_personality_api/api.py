...
from tensorflow.contrib import learn  # deprecated, should change to tf.data or tensorflow/transform
...
modelNames = [dir_path + '/model/extr/model-2300',
              dir_path + '/model/agr/model-6900',
              dir_path + '/model/cons/model-5750',
              dir_path + '/model/emot/model-5750',
              dir_path + '/model/openn/model-5175']
    ...
    for checkpoint_file in modelNames:
        ...
        with graph.as_default():
            ...
            with sess.as_default():
                ...
                personality_result[bigFive[counter]] = float(str(softmax(scores)[0][1]))
